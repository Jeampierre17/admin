          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div className="chart-container">
                <div className="chart-bar" style={{height: "40%"}}><span>ENERO</span></div>
                <div className="chart-bar" style={{height: "60%"}}><span>FEBRERO</span></div>
                <div className="chart-bar" style={{height: "80%"}}><span>MARZO</span></div>
                <div className="chart-bar" style={{height: "70%"}}><span>ABRIL</span></div>
                <div className="chart-bar" style={{height: "50%"}}><span>MAYO</span></div>
                <div className="chart-bar" style={{height: "30%"}}><span>JUNIO</span></div>
                <div className="chart-bar" style={{height: "20%"}}><span>JULIO</span></div>
                <div className="chart-bar" style={{height: "40%"}}><span>AGOSTO</span></div>
                <div className="chart-bar" style={{height: "60%"}}><span>SEPTIEMBRE</span></div>
                <div className="chart-bar" style={{height: "80%"}}><span>OCTUBRE</span></div>
                <div className="chart-bar" style={{height: "70%"}}><span>NOVIEMBRE</span></div>
                <div className="chart-bar" style={{height: "50%"}}><span>DICIEMBRE</span></div>
              </div>
          ...
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              ...
              <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"><label><select class="dataTable-selector"><option value="5">5</option><option value="10" selected="">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select> entries per page</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"/></div></div><div class="dataTable-container"><table class="table table-borderless datatable dataTable-table">
                <thead>
                  <tr><th scope="col" data-sortable=""><a href="#" class="dataTable-sorter">#</a></th><th scope="col" data-sortable=""><a href="#" class="dataTable-sorter">Customer</a></th><th scope="col" data-sortable=""><a href="#" class="dataTable-sorter">Product</a></th><th scope="col" data-sortable=""><a href="#" class="dataTable-sorter">Price</a></th><th scope="col" data-sortable="" ><a href="#" class="dataTable-sorter">Status</a></th></tr>
                </thead>
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        ...
        <div class="card-body pb-0">
          ...
          <div id="budgetChart" class="echart" _echarts_instance_="ec_1681959084229"><div ><canvas data-zr-dom-id="zr_0" width="987" height="500" ></canvas></div></div>
{/*
          <script>
      ...
      <div class="card">
        ...
        <div class="card-body pb-0">
          ...
          <div id="trafficChart"  class="echart" _echarts_instance_="ec_1681959084230"><div><canvas data-zr-dom-id="zr_0" width="987" height="500"></canvas></div><div class=""></div></div>
